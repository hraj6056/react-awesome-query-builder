...
import { AntdWidgets } from '@314e-react-awesome-query-builder/antd';
...
[source,javascript]
----
import {CustomOperators: {ProximityOperator}} from '@314e-react-awesome-query-builder/ui';
----
...
[source,javascript]
----
import {VanillaWidgets} from '@314e-react-awesome-query-builder/ui';
import {AntdWidgets} from '@314e-react-awesome-query-builder/antd';
import {MuiWidgets} from '@314e-react-awesome-query-builder/mui';
import {MaterialWidgets} from '@314e-react-awesome-query-builder/material'; // MUI v4
...
[source,javascript]
----
import { BasicFuncs } from '@314e-react-awesome-query-builder/ui';
const config = {
  //...
  funcs: {
